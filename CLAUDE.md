...
| `docs/read-blueprint.md` | How a generative feature gets built here. Eight phases, eight gates |
| `docs/s7-decision.md` | **OPEN.** Pattern vs reading, and what a read may cost. Preliminary |
